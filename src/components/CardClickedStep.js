      ...
      <Grid>
        ...
        <Grid>
          <Typography style={{fontSize:"3vmin"}} color="black" component="p">
              {
                (this.props.clickedvote === "areaofgreatestneed")
                ? <React.Fragment><p>Protecting the planet copy</p> <p><strong><a style={{textDecoration:"", color:"#000000"}} target="_blank" rel="noopener noreferrer" href="https://givingday.asu.edu/"> Learn More</a></strong></p></React.Fragment>

                : (this.props.clickedvote === "k12support")
                ? <React.Fragment><p>Conducting research for the public good copy</p> <p><strong><a style={{textDecoration:"", color:"#000000"}} target="_blank" rel="noopener noreferrer" href="https://givingday.asu.edu/"> Learn More</a></strong></p></React.Fragment>

                : (this.props.clickedvote === "communityemergencysupport")
                ? <React.Fragment><p>Advancing student access copy</p> <p><strong><a style={{textDecoration:"", color:"#000000"}} target="_blank" rel="noopener noreferrer" href="https://givingday.asu.edu/"> Learn More</a></strong></p></React.Fragment>

                : (this.props.clickedvote === "individualemergencysupport")
                ? <React.Fragment><p>Serving our community copy</p> <p><strong><a style={{textDecoration:"", color:"#000000"}} target="_blank" rel="noopener noreferrer" href="https://givingday.asu.edu/"> Learn More</a></strong></p></React.Fragment>

                : (this.props.clickedvote === "researchsupport")
                ? <React.Fragment><p>Creating equity in higher education copy</p> <p><strong><a style={{textDecoration:"", color:"#000000"}} target="_blank" rel="noopener noreferrer" href="https://givingday.asu.edu/"> Learn More</a></strong></p></React.Fragment>
